...
describe('Staking',function(){
    ...
    describe('deploy',function(){
        ...
        it('set up tiers and lockup periods',async function(){
    ...
    describe('stakeEther ',function(){
        ...
        it('adds address and positionID to positionIdsByAddress',async function(){
            ...
            const result = await staking.positionIdsByAddress(signer2.address,0)
    ...
    describe('modifyLockPeriods',function(){
        ...
        describe('non-owner',function(){
            it('reverts',async function(){
                expect(staking.connect(signer2).modifyLockPeriods(100,999)).to.be.revertedWith('Only owner may modify staking period');
            })
        })
    })
    ...
    describe('getInterestRate',function(){
        it('returns the interest rate for a spacific lock period',async() => {
            const interestRate = await staking.getInterestRate(30);
            expect(interestRate).to.equal(700);
        })
    })
    describe('getPositionById',function(){
        it('returns the data about a specific position, given a positionId',async() => {
           const provider = waffle.provider;
